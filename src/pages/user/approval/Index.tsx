...
const Approval = () => {
  ...
  const [isReimbursementPopupOpen, setReimbursementPopupOpen] =
  ...
  return (
    <section>
      ...
      <div className="px-24 mt-10 flex flex-col sm:flex-row">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="flex flex-col sm:w-[90%] md:w-[80%] lg:w-[80vw] xl:w-[80vw]"
        >
          <motion.div
          ...
          >
            <div className="flex gap-5 justify-center">
              <div
                className={`sm:flex md:flex lg:flex ${
                  mode === false ? "hidden" : ""
                }`}
              >
                <Button
            ...
            <div className="flex flex-row justify-center sm:justify-center gap-5 mt-5 md:justify-center  lg:justify-center ">
              <div>
                <Button
                  ...
                  } text-white  px-2 sm:px-8 md:px-9 lg:px-10`}
                />
              </div>
              <div>
                <Button
      ...
      <Popup
        isOpen={isTimeoffPopupOpen}
        onClose={() => setTimeoffPopupOpen(false)}
      >
      ...
      <Popup
        isOpen={isReimbursementPopupOpen}
        onClose={() => setReimbursementPopupOpen(false)}
      >
        <div className="sm:w-full md:w-[500px] lg:w-[700px] xl:w-[900px] bg-white rounded-lg shadow-lg p-4">
          <div className="text-center text-[24px] font-semibold">
